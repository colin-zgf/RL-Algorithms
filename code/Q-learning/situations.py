...
m, op, stats = QLearning(env,2000,alpha=0.2,epsilon=0.6)
...
#    print('a is:',a)
    ...
    if is_terminal(ns[0],ns[1]):
        ...
        break
    s = ns
visualize_trajectory(ax, traj, plot_actions=True)
plotting.plot_episode_stats(stats)
#ax.sets_title("Trajectory Example 1")